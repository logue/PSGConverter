...
(function($){
	...
	$(document).ready(function(){
		$('.mabimml').each(function(){
			...
			var url = 'data:audio/x-midi;base64,'+base64encode(mabimml_genmidi({"inst":inst,"mml":MML}) );
			$this.before([
//				'<a class="btn btn-small mml-debug" href="'+url+'">debug.mid</a>',
				'<object classid="clsid:02BF25D5-8C17-4B23-BC80-D3488ABDDC6B"  type="application/x-quicktimeplayer" width="320" height="16" class="mml-player">',
					'<param name="controller" value="true" >',
					'<param name="autoplay" value="true">',
					'<param name="src" value="'+url+'" >',
					'<object type="video/quicktime" width="320" height="16" data="'+url+'">',
						'<param name="controller" value="true" >',
